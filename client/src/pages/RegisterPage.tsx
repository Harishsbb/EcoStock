...
import { Boxes, AlertCircle, Store } from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-6 text-slate-100 font-sans">
      <div className="w-full max-w-md space-y-8 bg-slate-900/80 border border-slate-800 p-8 rounded-3xl shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 justify-center mb-4">
          ...
          <h1 className="font-extrabold text-xl text-white">SmartStock</h1>
        </div>

        <div className="text-center">
          <h2 className="text-2xl font-bold text-white">Register Shop Account</h2>
          <p className="text-xs text-slate-400 mt-1">Start optimizing inventory and reducing waste in minutes.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold text-slate-300 uppercase mb-1">Owner Full Name</label>
            <input
              type="text"
              name="name"
              required
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 uppercase mb-1">Shop / Store Name</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-slate-100 text-sm focus:outline-none focus:border-emerald-500"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-slate-950 font-bold text-sm shadow-lg shadow-emerald-500/25 hover:from-emerald-400 hover:to-teal-400 transition-all flex items-center justify-center gap-2 mt-4"
          >
